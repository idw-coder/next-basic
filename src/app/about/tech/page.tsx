    ...
    <EntryGuard>
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <section className="mb-12">
          <h2 className="text-lg font-semibold mb-4 border-b pb-2">システム構成図</h2>
          <MermaidDiagram chart={ARCHITECTURE_CHART} id="architecture-diagram" />
          <p className="text-xs text-muted-foreground mt-3">
            Nginx をリバースプロキシとして、Next.js・Express.js&nbsp;API・管理画面を統合配信
          </p>
        </section>
          ...
          <div className="space-y-8">
            {techStack.map((section) => (
              <div key={section.category}>
                <h3 className="mb-2">
                  <span className="text-sm bg-gray-100 px-4 p-2 rounded-md font-semibold tracking-wide">
                    {section.category}
                  </span>
                </h3>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-4 border-b pb-2">ソースコード</h2>
