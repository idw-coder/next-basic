    ...
    <nav className="mt-12 flex flex-col sm:flex-row gap-3 border-t border-gray-200 pt-8">
      {prev ? (
        <Link
          ...
          className="group flex flex-1 items-center gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm transition hover:border-primary/30 hover:bg-gray-50"
        >
      ...
      {next ? (
        <Link
          ...
          className="group flex flex-1 items-center justify-end gap-2 rounded-lg border border-gray-200 px-4 py-3 text-sm transition hover:border-primary/30 hover:bg-gray-50 text-right"
        >
          <div className="min-w-0">
