...
- [Map — あらゆる型をキーにできる連想配列](#map)
- [Set — 重複しない値のコレクション](#set)
- [WeakMap・WeakSet — GCに優しいコレクション](#weakmap-weakset)
- [WeakRef・FinalizationRegistry — 弱参照と後始末](#weakref-finalizationregistry)
