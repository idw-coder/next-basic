...
<Figure src="/images/deskwork_check_man_color.png" alt="Tailwindをセットアップしているイメージ" maxWidth="220px" />
...
Tailwind v3の記事では `tailwind.config.js`、`postcss.config.js`、`@tailwind base` などが登場します。v4の新規プロジェクトでは構成がかなり簡略化されているため、検索するときは「Tailwind CSS v4」「Next.js App Router」まで入れると混乱しにくくなります。
</Callout>
