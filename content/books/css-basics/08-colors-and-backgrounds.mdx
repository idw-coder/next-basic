...
- <Marker>デザインツールからの受け渡しは**HEX**が最もスムーズ</Marker>
...
- [MDN — CSS color value](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Values/color_value) — HEX/RGB/HSL等すべての色形式の一覧
- [MDN — oklch()](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Values/color_value/oklch) — `oklch()` 関数のリファレンス
- [MDN — linear-gradient()](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Values/gradient/linear-gradient) — 線形グラデーションのリファレンス
- [MDN — background](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Properties/background) — `background` ショートハンドのリファレンス
