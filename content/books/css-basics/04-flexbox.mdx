...
- [MDN — フレックスボックスの基本概念](https://developer.mozilla.org/ja/docs/Web/CSS/Guides/Flexible_box_layout/Basic_concepts) — 主軸・交差軸などFlexbox基本概念の公式ガイド
- [MDN — flex](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Properties/flex) — `flex`（grow/shrink/basis）のリファレンス
- [MDN — justify-content](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Properties/justify-content) — 主軸方向の配置の全値
- [MDN — gap](https://developer.mozilla.org/ja/docs/Web/CSS/Reference/Properties/gap) — `gap` のリファレンス
