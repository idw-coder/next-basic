...
このサイト自身がこの設定です。デザインはTailwindで作り、管理画面のテーブルやダイアログにだけMUIを使っています。詳しい仕組みは、[他のCSSと共存する](/books/mui/coexisting-with-other-css)で扱います。
...
- [Next.js integration — MUI公式](https://mui.com/material-ui/integrations/nextjs/)
- [Installation — MUI公式](https://mui.com/material-ui/getting-started/installation/)
- [App Router — Next.js公式ドキュメント](https://nextjs.org/docs/app)
