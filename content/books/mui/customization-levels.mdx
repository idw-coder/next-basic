...
次の章では、`styleOverrides` では届かない領域である[slotsとslotProps](/books/mui/slots-and-slot-props)を扱います。

---

## 参考リンク

- [How to customize — MUI公式](https://mui.com/material-ui/customization/how-to-customize/)
- [styled() — MUI公式](https://mui.com/system/styled/)
- [Themed components — MUI公式](https://mui.com/material-ui/customization/theme-components/)
