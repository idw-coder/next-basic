...
次の章では、文字を扱う[Typographyコンポーネント](/books/mui/typography)を扱います。見た目とHTMLタグを分けて指定する仕組みが中心です。

---

## 参考リンク

- [Grid — MUI公式](https://mui.com/material-ui/react-grid/)
- [Stack — MUI公式](https://mui.com/material-ui/react-stack/)
- [Box — MUI公式](https://mui.com/material-ui/react-box/)
- [Container — MUI公式](https://mui.com/material-ui/react-container/)
