...
- [GitHub公式ドキュメント：Pull Requestのマージ](https://docs.github.com/ja/pull-requests/reference/pull-request-merges)
...
> **次のステップ**: Pull Requestベースの開発に慣れたら、次は「マージ前にテストとlintを自動で走らせる」世界へ。[『GitHub ActionsでCI/CDをはじめる』](/books/github-actions/01-what-is-cicd)で、pushやPull Requestをきっかけにした自動化を学べます。
