...
<Marker>主キーはその行自身の識別子です。外部キーは参照先の主キー値を格納する列であり、その行自身を識別するためのものではありません。</Marker>
...
<Figure src="/images/readingbook_woman_color.png" caption="データ構造を理解してからSQLを書くことで、無駄のない設計・クエリにつながります" />
