...
<Marker>JOINは、2つのテーブルの各行を `ON` 句で突き合わせ、条件が真になる組み合わせだけを、両方の列を含む1行として返す操作です。</Marker>
...
<Figure src="/images/meeting_color.png" caption="JOINはテーブル同士の関係を理解して正しく結合することが重要です" />
