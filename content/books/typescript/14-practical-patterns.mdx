...
- [TypeScript Handbook — Utility Types（英語）](https://www.typescriptlang.org/docs/handbook/utility-types.html) — 実践パターンの土台になる公式リファレンス
- [TypeScript Handbook — Conditional Types（英語）](https://www.typescriptlang.org/docs/handbook/2/conditional-types.html) — 条件付き型の公式ガイド
- [TypeScript Playground](https://www.typescriptlang.org/ja/play/) — 型の挙動をその場で確認できる公式ツール
