...
- [typeof による絞り込み](#section-1)
- [instanceof による絞り込み](#section-2)
- [in による絞り込み](#section-3)
- [判別可能なユニオン（Discriminated Union）](#section-4)
- [網羅性チェック — never を使って漏れを検出する](#section-5)
- [真偽値チェックによる絞り込み](#section-6)
- [早期 return と throw による Narrowing](#section-7)
- [まとめ](#section-8)
