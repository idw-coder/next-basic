...
- [TypeScript Handbook — Utility Types（英語）](https://www.typescriptlang.org/docs/handbook/utility-types.html) — 全ユーティリティ型の公式リファレンス
- [TypeScript Handbook — Mapped Types（英語）](https://www.typescriptlang.org/docs/handbook/2/mapped-types.html) — ユーティリティ型の内部で使われるMapped Typesの公式説明
