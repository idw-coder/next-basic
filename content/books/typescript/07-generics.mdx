...
- [TypeScript Handbook — Generics（英語）](https://www.typescriptlang.org/docs/handbook/2/generics.html) — ジェネリクスの公式ガイド
- [TypeScript Handbook — Keyof Type Operator（英語）](https://www.typescriptlang.org/docs/handbook/2/keyof-types.html) — ジェネリクスと組み合わせて使うkeyofの公式説明
