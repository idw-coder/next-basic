...
- [TypeScript Handbook — Everyday Types（英語）](https://www.typescriptlang.org/docs/handbook/2/everyday-types.html) — 基本の型の公式リファレンス
- [MDN — JavaScript のデータ構造](https://developer.mozilla.org/ja/docs/Web/JavaScript/Guide/Data_structures) — ベースとなるJavaScript側の型の仕組み
